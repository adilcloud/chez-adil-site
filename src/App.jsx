  ...
  return (
    <div className="ca-app">
      ...
      <div className="ca-header">
        ...
        <div className="ca-rivet" style={{ top: 10, right: 10 }} />
        <p className="ca-logo">
          Chez <span>Adil</span>
        </p>
        ...
        <p className="ca-tagline">Street food premium · depuis 2016 · Caen &amp; alentours</p>
        <div className="ca-today-strip">
          {STOPS[todayIdx].place ? (
            ...
            <>Pas de service aujourd'hui — prochaine étape dans l'onglet Tournée</>
          )}
        </div>
      </div>
      ...
      <div className="ca-body">
        {tab === "planning" && (
          <div>
            ...
            <h3 className="ca-h3">La tournée du camion</h3>
            {STOPS.map((s) => (
              <div
                key={s.day}
        ...
        {tab === "prestations" && (
          <div>
            ...
            <p className="ca-item-desc" style={{ marginBottom: 14 }}>
              Entreprise, anniversaire, mariage : remplis le formulaire, la demande part
              directement par WhatsApp au camion.
            </p>

            {sent ? (
              <div className="ca-card">
                <p className="ca-presta-desc">
                  Ta demande est prête à être envoyée sur WhatsApp. Si l'appli ne s'est pas
            ...
            <div className="ca-presta-desc">
              Chaque prestation est chiffrée selon le nombre de couverts, le lieu et les options
