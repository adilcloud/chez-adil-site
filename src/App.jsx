...
const GOOGLE_MAPS_URL = "https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent("Chez Adil Food Truck Burger Caen");

const REVIEWS = [
  {
    author: "Morgane Sauvage",
    rating: 5,
